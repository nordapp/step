...
@Command(scope = "ob", name = "deploy-resources", description="Deploys a script bundle resource")
public class DeployResourcesCommand extends OsgiCommandSupport {
	
	static Logger logger = LoggerFactory.getLogger(DeployResourcesCommand.class);
