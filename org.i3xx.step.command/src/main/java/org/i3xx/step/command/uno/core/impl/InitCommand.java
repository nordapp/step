...
@Command(scope = "ob", name = "uno-init", description="Initializes the uno script engine (proceed after destroy.)")
public class InitCommand extends OsgiCommandSupport {
	
	static Logger logger = LoggerFactory.getLogger(InitCommand.class);
	...
	protected Object doExecute() throws Exception {
        ...
        logger.info("Uno initialize mandator-id: '{}'", mandatorId);
