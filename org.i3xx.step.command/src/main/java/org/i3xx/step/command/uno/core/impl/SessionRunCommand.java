...
@Command(scope = "ob", name = "uno-session-run", description="Runs a session on the mandator service")
public class SessionRunCommand extends OsgiCommandSupport {
	
	static Logger logger = LoggerFactory.getLogger(SessionRunCommand.class);
