...
@Command(scope = "ob", name = "uno-session-logout", description="Logout from the session")
public class SessionLogoutCommand extends OsgiCommandSupport {
	
	static Logger logger = LoggerFactory.getLogger(SessionLogoutCommand.class);
	 ...
	 * 
	 */
	public SessionLogoutCommand() {
	}

	@Override
	protected Object doExecute() throws Exception {
		
        logger.info("Logout mandator-id: '{}', session-id:'{}'", mandatorId, sessionId);
		...
		if(mandator!=null) {
			...
			baseService.dropEngine(sessionId);
		}//fi
