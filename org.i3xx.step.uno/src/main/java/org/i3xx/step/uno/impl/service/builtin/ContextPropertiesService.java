 ...
 *
 */
public class ContextPropertiesService implements BuiltinService {
	
	private static Logger logger = LoggerFactory.getLogger(ContextPropertiesService.class);
	
	private ContextImpl.ContextService context;
	
	public ContextPropertiesService(ContextImpl.ContextService context) {
